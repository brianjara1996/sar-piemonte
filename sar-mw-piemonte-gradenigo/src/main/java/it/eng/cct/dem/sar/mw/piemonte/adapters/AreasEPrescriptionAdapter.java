...
public class AreasEPrescriptionAdapter extends MessageAdapter {
	...
	protected void transcodeAndSetAccessType(Object bean, String property, String value) {
		...
		if (value.equals(WS_TIESSE_ACCESS_TYPE_FIRST)) {
			this.setIfNotEmpty(bean, property, WS_EPRESCRIPTION_ACCESS_TYPE_FIRST);
		} else if (value.equals(WS_TIESSE_ACCESS_TYPE_OTHER)) {
